                                ...
                                <div class="signup">
                                    ...
                                    <div class="form-holder fcard mt-4">
                                            ...
                                            <tr>
                                                <td class="p-0">
                                                    <div class="input-group flex-nowrap form-group">
                                                        ...
                                                        <input type="text" class="input" name="fname" placeholder="Hospital name" id="Hname" required>
                                                    </div>
                                                </td>
                                                <td  class="p-0">
                                                    <div class="input-group flex-nowrap form-group">
                                                        <span class="input-group-text"> <i class="bi bi-person-fill"></i></span>
                                                        <input type="text" class="input" name="hid" placeholder="Hospital id" id="Hid" required>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="p-0">
                                                    <div class="input-group flex-nowrap form-group col-md-6">
                                                        ...
                                                        <input type="text" class="input" name="address" placeholder="Address" id="address" required>
                                                    </div>
                                                </td>
                                            </tr>
                                     </table>
                                     <div class="input-group flex-nowrap form-group col-md-6">
                                        ...
                                        <input type="text" class="input" name="tnum" placeholder="Telephone Number" id="tnum" required>
                                    </div>
                                        ...
                                        <div class="input-group flex-nowrap form-group col-md-6">
                                            ...
                                            <input type="password" class="input" name="pw" placeholder="Password" id="pw" required>
                                        </div>
                                        ...
                                        <div class="input-group flex-nowrap form-group col-md-6">
                                            ...
                                            <input type="password" class="input" name="repassword" placeholder="Re-Enter Password" id="uname" required>
                                        </div>
