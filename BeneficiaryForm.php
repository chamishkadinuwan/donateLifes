    ...
    <div class="container-fluid flex-wrap bg-light p-0 mb-4 col-md-12">
        <header class="d-flex flex-wrap justify-content-center py-3 mb-3 container-fluid ">
            <div class="container p-0 m-0">
                <div class="row">
                    <div class="col-md-1 ">
                        <a href="HomePage.html" class="d-flex justify-content-center mb- mb-md-0 me-md-auto text-dark text-decoration-none">
                    ...
                    <div class="col-md-4">
                        <ul class=" nav nav-pills flex-wrap justify-content-center">
                            <li class="nav-item"><a href="HomePage.html" class="ps-2 nav-link none" aria-current="#">Home</a>
                            </li>
